...
const componentsByPath = {
    ...
    "home": {name: "Home", projectId: "wTfrcKJbyc1xMyCJGZjH7d" },
  
    "pricing": {name: "Pricing", projectId: "wTfrcKJbyc1xMyCJGZjH7d" },
  
    "features": {name: "Features", projectId: "wTfrcKJbyc1xMyCJGZjH7d" },
